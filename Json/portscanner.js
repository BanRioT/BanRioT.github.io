...
function lookupIPAddress() {
  const ipInput = document.querySelector('.pscan-text');
...
ISP .... <span class="green">${data.isp}</span>`;
      ...
      const outputText = document.querySelector('.pscan-output');
...
document.addEventListener('keydown', function (e) {
  if (e.key === 'Enter' && e.target.classList.contains('pscan-text')) {
